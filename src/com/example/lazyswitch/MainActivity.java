...
public class MainActivity extends Activity {
    ...
    public void onTurnOnClicked(View view){
    	if(sp.getBoolean("isConnected", false)==true){
    		...
    		Toast.makeText(getApplicationContext(), "请与智能跟踪机器人连接", 0).show();
    	}
    ...
    public void sendCommand(String command){
    	...
    	try {
    		...
    		os.write(bos_new);	
    		Toast.makeText(getApplicationContext(), "发送数据成功！", 0).show();
		} catch (IOException e) {
			
			Toast.makeText(getApplicationContext(), "发送数据失败！", 0).show();
			e.printStackTrace();
		} 
    }
    	else
